...
bool MMatchItemDescMgr::ParseItem(MXmlElement& element)
{
	...
	for (int i = 0; i < nAttrCount; i++)
	{
		...
		else if (!stricmp(szAttrName, MICTOK_WEAPON))
		{
			...
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_DAGGER_RARE))		pNewDesc->m_nWeaponType.Set(MWT_DAGGER_RARE);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_DUALDAGGER_RARE))	pNewDesc->m_nWeaponType.Set(MWT_DUAL_DAGGER_RARE);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_KATANA_RARE))		pNewDesc->m_nWeaponType.Set(MWT_KATANA_RARE);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_GREATSWORD_RARE))	pNewDesc->m_nWeaponType.Set(MWT_GREAT_SWORD_RARE);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_DOUBLEKATANA_RARE))	pNewDesc->m_nWeaponType.Set(MWT_DOUBLE_KATANA_RARE);

			else if (!stricmp(szAttrValue, MICTOK_WEAPON_PISTOL_RARE))		pNewDesc->m_nWeaponType.Set(MWT_PISTOL_RARE);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_PISTOLX2_RARE))		pNewDesc->m_nWeaponType.Set(MWT_PISTOLx2_RARE);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_REVOLVER_RARE))		pNewDesc->m_nWeaponType.Set(MWT_REVOLVER_RARE);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_REVOLVERX2_RARE))	pNewDesc->m_nWeaponType.Set(MWT_REVOLVERx2_RARE);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_SMG_RARE))			pNewDesc->m_nWeaponType.Set(MWT_SMG_RARE);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_SMGX2_RARE))		pNewDesc->m_nWeaponType.Set(MWT_SMGx2_RARE);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_SHOTGUN_RARE))		pNewDesc->m_nWeaponType.Set(MWT_SHOTGUN_RARE);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_SAWEDSHOTGUN_RARE))	pNewDesc->m_nWeaponType.Set(MWT_SAWED_SHOTGUN_RARE);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_RIFLE_RARE))		pNewDesc->m_nWeaponType.Set(MWT_RIFLE_RARE);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_MACHINEGUN_RARE))	pNewDesc->m_nWeaponType.Set(MWT_MACHINEGUN_RARE);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_ROCKET_RARE))		pNewDesc->m_nWeaponType.Set(MWT_ROCKET_RARE);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_SNIFER_RARE))		pNewDesc->m_nWeaponType.Set(MWT_SNIFER_RARE);

			else if (!stricmp(szAttrValue, MICTOK_WEAPON_MEDKIT_RARE))		pNewDesc->m_nWeaponType.Set(MWT_MED_KIT_RARE);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_REPAIRKIT_RARE))	pNewDesc->m_nWeaponType.Set(MWT_REPAIR_KIT_RARE);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_BULLETKIT_RARE))	pNewDesc->m_nWeaponType.Set(MWT_BULLET_KIT_RARE);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_FLASHBANG_RARE))	pNewDesc->m_nWeaponType.Set(MWT_FLASH_BANG_RARE);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_FRAG_RARE))			pNewDesc->m_nWeaponType.Set(MWT_FRAGMENTATION_RARE);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_SMOKE_RARE))		pNewDesc->m_nWeaponType.Set(MWT_SMOKE_GRENADE_RARE);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_SKILL_RARE))		pNewDesc->m_nWeaponType.Set(MWT_SKILL_RARE);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_FOOD_RARE))			pNewDesc->m_nWeaponType.Set(MWT_FOOD_RARE);

			//EXOTIC

			else if (!stricmp(szAttrValue, MICTOK_WEAPON_DAGGER_EXOTIC))		pNewDesc->m_nWeaponType.Set(MWT_DAGGER_EXOTIC);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_DUALDAGGER_EXOTIC))	pNewDesc->m_nWeaponType.Set(MWT_DUAL_DAGGER_EXOTIC);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_KATANA_EXOTIC))		pNewDesc->m_nWeaponType.Set(MWT_KATANA_EXOTIC);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_GREATSWORD_EXOTIC))	pNewDesc->m_nWeaponType.Set(MWT_GREAT_SWORD_EXOTIC);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_DOUBLEKATANA_EXOTIC))	pNewDesc->m_nWeaponType.Set(MWT_DOUBLE_KATANA_EXOTIC);

			else if (!stricmp(szAttrValue, MICTOK_WEAPON_PISTOL_EXOTIC))		pNewDesc->m_nWeaponType.Set(MWT_PISTOL_EXOTIC);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_PISTOLX2_EXOTIC))		pNewDesc->m_nWeaponType.Set(MWT_PISTOLx2_EXOTIC);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_REVOLVER_EXOTIC))		pNewDesc->m_nWeaponType.Set(MWT_REVOLVER_EXOTIC);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_REVOLVERX2_EXOTIC))	pNewDesc->m_nWeaponType.Set(MWT_REVOLVERx2_EXOTIC);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_SMG_EXOTIC))			pNewDesc->m_nWeaponType.Set(MWT_SMG_EXOTIC);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_SMGX2_EXOTIC))		pNewDesc->m_nWeaponType.Set(MWT_SMGx2_EXOTIC);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_SHOTGUN_EXOTIC))		pNewDesc->m_nWeaponType.Set(MWT_SHOTGUN_EXOTIC);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_SAWEDSHOTGUN_EXOTIC))	pNewDesc->m_nWeaponType.Set(MWT_SAWED_SHOTGUN_EXOTIC);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_RIFLE_EXOTIC))		pNewDesc->m_nWeaponType.Set(MWT_RIFLE_EXOTIC);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_MACHINEGUN_EXOTIC))	pNewDesc->m_nWeaponType.Set(MWT_MACHINEGUN_EXOTIC);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_ROCKET_EXOTIC))		pNewDesc->m_nWeaponType.Set(MWT_ROCKET_EXOTIC);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_SNIFER_EXOTIC))		pNewDesc->m_nWeaponType.Set(MWT_SNIFER_EXOTIC);

			else if (!stricmp(szAttrValue, MICTOK_WEAPON_MEDKIT_EXOTIC))		pNewDesc->m_nWeaponType.Set(MWT_MED_KIT_EXOTIC);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_REPAIRKIT_EXOTIC))	pNewDesc->m_nWeaponType.Set(MWT_REPAIR_KIT_EXOTIC);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_BULLETKIT_EXOTIC))	pNewDesc->m_nWeaponType.Set(MWT_BULLET_KIT_EXOTIC);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_FLASHBANG_EXOTIC))	pNewDesc->m_nWeaponType.Set(MWT_FLASH_BANG_EXOTIC);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_FRAG_EXOTIC))			pNewDesc->m_nWeaponType.Set(MWT_FRAGMENTATION_EXOTIC);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_SMOKE_EXOTIC))		pNewDesc->m_nWeaponType.Set(MWT_SMOKE_GRENADE_EXOTIC);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_SKILL_EXOTIC))		pNewDesc->m_nWeaponType.Set(MWT_SKILL_EXOTIC);
			else if (!stricmp(szAttrValue, MICTOK_WEAPON_FOOD_EXOTIC))			pNewDesc->m_nWeaponType.Set(MWT_FOOD_EXOTIC);
...
//RARE
	case MIT_DAGGER_RARE:		return MWT_DAGGER_RARE;
	case MIT_DUAL_DAGGER_RARE:	return MWT_DUAL_DAGGER_RARE;
	case MIT_KATANA_RARE:		return MWT_KATANA_RARE;
	case MIT_GREAT_SWORD_RARE:	return MWT_GREAT_SWORD_RARE;
	case MIT_DOUBLE_KATANA_RARE:	return MWT_DOUBLE_KATANA_RARE;
//EXOTIC
	case MIT_DAGGER_EXOTIC:		return MWT_DAGGER_EXOTIC;
	case MIT_DUAL_DAGGER_EXOTIC:	return MWT_DUAL_DAGGER_EXOTIC;
	case MIT_KATANA_EXOTIC:		return MWT_KATANA_EXOTIC;
	case MIT_GREAT_SWORD_EXOTIC:	return MWT_GREAT_SWORD_EXOTIC;
	case MIT_DOUBLE_KATANA_EXOTIC:	return MWT_DOUBLE_KATANA_EXOTIC;
	default:
			// 없는 타입
			break;
	}
...
//RARE
	case RIT_PISTOL_RARE:		return MWT_PISTOL_RARE;
	case RIT_PISTOLx2_RARE:		return MWT_PISTOLx2_RARE;

	case RIT_REVOLVER_RARE:		return MWT_REVOLVER_RARE;
	case RIT_REVOLVERx2_RARE:	return MWT_REVOLVERx2_RARE;

	case RIT_SMG_RARE:			return MWT_SMG_RARE;
	case RIT_SMGx2_RARE:			return MWT_SMGx2_RARE;

	case RIT_SHOTGUN_RARE:		return MWT_SHOTGUN_RARE;
	case RIT_SAWED_SHOTGUN_RARE:	return MWT_SAWED_SHOTGUN_RARE;

	case RIT_RIFLE_RARE:			return MWT_RIFLE_RARE;
	case RIT_MACHINEGUN_RARE:	return MWT_MACHINEGUN_RARE;
	case RIT_ROCKET_RARE:		return MWT_ROCKET_RARE;
	case RIT_SNIFER_RARE:		return MWT_SNIFER_RARE;
//EXOTICS
	case RIT_PISTOL_EXOTIC:		return MWT_PISTOL_EXOTIC;
	case RIT_PISTOLx2_EXOTIC:		return MWT_PISTOLx2_EXOTIC;

	case RIT_REVOLVER_EXOTIC:		return MWT_REVOLVER_EXOTIC;
	case RIT_REVOLVERx2_EXOTIC:	return MWT_REVOLVERx2_EXOTIC;

	case RIT_SMG_EXOTIC:			return MWT_SMG_EXOTIC;
	case RIT_SMGx2_EXOTIC:			return MWT_SMGx2_EXOTIC;

	case RIT_SHOTGUN_EXOTIC:		return MWT_SHOTGUN_EXOTIC;
	case RIT_SAWED_SHOTGUN_EXOTIC:	return MWT_SAWED_SHOTGUN_EXOTIC;

	case RIT_RIFLE_EXOTIC:			return MWT_RIFLE_EXOTIC;
	case RIT_MACHINEGUN_EXOTIC:	return MWT_MACHINEGUN_EXOTIC;
	case RIT_ROCKET_EXOTIC:		return MWT_ROCKET_EXOTIC;
	case RIT_SNIFER_EXOTIC:		return MWT_SNIFER_EXOTIC;
	case RIT_WFGUN_EXOTIC:			return MWT_SNIFER_EXOTIC;
	default:
			// 없는 타입
			//_ASSERT(0);
			break;
...
//RARE
	case MMCIT_MED_KIT_RARE:				return MWT_MED_KIT_RARE;
	case MMCIT_REPAIR_KIT_RARE:			return MWT_REPAIR_KIT_RARE;
	case MMCIT_BULLET_KIT_RARE:			return MWT_BULLET_KIT_RARE;
	case MMCIT_FLASH_BANG_RARE:			return MWT_FLASH_BANG_RARE;
	case MMCIT_FRAGMENTATION_RARE:		return MWT_FRAGMENTATION_RARE;
	case MMCIT_SMOKE_GRENADE_RARE:		return MWT_SMOKE_GRENADE_RARE;
	case MMCIT_ENCHANT_FIRE_RARE:		return MWT_ENCHANT_FIRE_RARE;
	case MMCIT_ENCHANT_COLD_RARE:		return MWT_ENCHANT_COLD_RARE;
	case MMCIT_ENCHANT_LIGHTNING_RARE:	return MWT_ENCHANT_LIGHTNING_RARE;
	case MMCIT_ENCHANT_POISON_RARE:		return MWT_ENCHANT_POISON_RARE;
	case MMCIT_FOOD_RARE:				return MWT_FOOD_RARE;
	case MMCIT_POTION_RARE:				return MWT_POTION_RARE;

//EXOTIC
	case MMCIT_MED_KIT_EXOTIC:				return MWT_MED_KIT_EXOTIC;
	case MMCIT_REPAIR_KIT_EXOTIC:			return MWT_REPAIR_KIT_EXOTIC;
	case MMCIT_BULLET_KIT_EXOTIC:			return MWT_BULLET_KIT_EXOTIC;
	case MMCIT_FLASH_BANG_EXOTIC:			return MWT_FLASH_BANG_EXOTIC;
	case MMCIT_FRAGMENTATION_EXOTIC:		return MWT_FRAGMENTATION_EXOTIC;
	case MMCIT_SMOKE_GRENADE_EXOTIC:		return MWT_SMOKE_GRENADE_EXOTIC;
	case MMCIT_ENCHANT_FIRE_EXOTIC:		return MWT_ENCHANT_FIRE_EXOTIC;
	case MMCIT_ENCHANT_COLD_EXOTIC:		return MWT_ENCHANT_COLD_EXOTIC;
	case MMCIT_ENCHANT_LIGHTNING_EXOTIC:	return MWT_ENCHANT_LIGHTNING_EXOTIC;
	case MMCIT_ENCHANT_POISON_EXOTIC:		return MWT_ENCHANT_POISON_EXOTIC;
	case MMCIT_FOOD_EXOTIC:				return MWT_FOOD_EXOTIC;
	case MMCIT_POTION_EXOTIC:				return MWT_POTION_EXOTIC;
