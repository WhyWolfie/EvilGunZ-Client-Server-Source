...
#define QUEST_DYNAMIC_WORLDITEM_LIFETIME	60000
...
#define MAX_REWARD_COUNT			90					// 최대 DB업데이트 없이 보상받을수 있는 수. (아이템의 종류를 기준. ex. 날고기:2, 불고기:3 일경우 +2가 된다.)
#define MAX_QUSET_PLAYER_COUNT		4

#define MAX_SACRIFICE_SLOT_COUNT 2	// 희생 아이템을 올려놓을수 있는 슬롯의 최대 수.

// Quest와 관련된 DB 상수 값.
#define MAX_DB_QUEST_ITEM_SIZE		999
