...
enum MMatchCustomItemType
{
	...
	MMCIT_FOOD,
//RARE
	MMCIT_MED_KIT_RARE		= 11,
	MMCIT_REPAIR_KIT_RARE,
	MMCIT_BULLET_KIT_RARE,
	MMCIT_DYNAMITE_RARE,
	MMCIT_REMOTE_CHARGE_RARE,
	MMCIT_DEMOLITION_TOOLS_RARE,
	MMCIT_FLASH_BANG_RARE,
	MMCIT_FRAGMENTATION_RARE,
	MMCIT_SMOKE_GRENADE_RARE,
	MMCIT_TEARGAS_GRENADE_RARE,
	MMCIT_FOOD_RARE,
//EXOTIC
	MMCIT_MED_KIT_EXOTIC		= 22,
	MMCIT_REPAIR_KIT_EXOTIC,
	MMCIT_BULLET_KIT_EXOTIC,
	MMCIT_DYNAMITE_EXOTIC,
	MMCIT_REMOTE_CHARGE_EXOTIC,
	MMCIT_DEMOLITION_TOOLS_EXOTIC,
	MMCIT_FLASH_BANG_EXOTIC,
	MMCIT_FRAGMENTATION_EXOTIC,
	MMCIT_SMOKE_GRENADE_EXOTIC,
	MMCIT_TEARGAS_GRENADE_EXOTIC,
	MMCIT_FOOD_EXOTIC,
	...
	MMCIT_ENCHANT_FIRE_RARE,			// 인챈트 아이템 - fire
	MMCIT_ENCHANT_COLD_RARE,			// 인챈트 아이템 - cold
	MMCIT_ENCHANT_LIGHTNING_RARE,	// 인챈트 아이템 - lightning
	MMCIT_ENCHANT_POISON_RARE,		// 인챈트 아이템 - poison

	MMCIT_ENCHANT_FIRE_EXOTIC,			// 인챈트 아이템 - fire
	MMCIT_ENCHANT_COLD_EXOTIC,			// 인챈트 아이템 - cold
	MMCIT_ENCHANT_LIGHTNING_EXOTIC,	// 인챈트 아이템 - lightning
	MMCIT_ENCHANT_POISON_EXOTIC,		// 인챈트 아이템 - poison

	MMCIT_POTION,				// 소모성 아이템 중 회복 계열 + 가속 포션
	MMCIT_POTION_RARE,				// 소모성 아이템 중 회복 계열 + 가속 포션
	MMCIT_POTION_EXOTIC,				// 소모성 아이템 중 회복 계열 + 가속 포션
...
//RARE
	MIT_DAGGER_RARE			= 5,
	MIT_DUAL_DAGGER_RARE		= 6,
	MIT_KATANA_RARE			= 7,
	MIT_GREAT_SWORD_RARE		= 8,
	MIT_DOUBLE_KATANA_RARE	= 9,
//EXOTIC
	MIT_DAGGER_EXOTIC			= 10,
	MIT_DUAL_DAGGER_EXOTIC		= 11,
	MIT_KATANA_EXOTIC			= 12,
	MIT_GREAT_SWORD_EXOTIC		= 13,
	MIT_DOUBLE_KATANA_EXOTIC	= 14,
...
//RARE
	RIT_PISTOL_RARE			= 13,
	RIT_PISTOLx2_RARE		= 14,
	RIT_REVOLVER_RARE		= 15,
	RIT_REVOLVERx2_RARE		= 16,
	RIT_SMG_RARE				= 17,
	RIT_SMGx2_RARE			= 18,
	RIT_SHOTGUN_RARE			= 19,
	RIT_SAWED_SHOTGUN_RARE	= 20,
	RIT_RIFLE_RARE			= 21,
	RIT_MACHINEGUN_RARE		= 22,
	RIT_ROCKET_RARE			= 23,
	RIT_SNIFER_RARE			= 24,
	RIT_WFGUN_RARE			= 25,
//EXOTIC
	RIT_PISTOL_EXOTIC			= 26,
	RIT_PISTOLx2_EXOTIC		= 27,
	RIT_REVOLVER_EXOTIC		= 28,
	RIT_REVOLVERx2_EXOTIC		= 29,
	RIT_SMG_EXOTIC				= 30,
	RIT_SMGx2_EXOTIC			= 31,
	RIT_SHOTGUN_EXOTIC			= 32,
	RIT_SAWED_SHOTGUN_EXOTIC	= 33,
	RIT_RIFLE_EXOTIC			= 34,
	RIT_MACHINEGUN_EXOTIC		= 35,
	RIT_ROCKET_EXOTIC			= 36,
	RIT_SNIFER_EXOTIC			= 37,
	RIT_WFGUN_EXOTIC			= 38,
...
//RARES
	...
	// melee
	MWT_DAGGER_RARE,
	MWT_DUAL_DAGGER_RARE,
	MWT_KATANA_RARE,
	MWT_GREAT_SWORD_RARE,
	MWT_DOUBLE_KATANA_RARE,
	...
	MWT_BULLET_KIT_RARE,
	MWT_FLASH_BANG_RARE,
	MWT_FRAGMENTATION_RARE,
	MWT_SMOKE_GRENADE_RARE,
	MWT_FOOD_RARE,
	MWT_SKILL_RARE,				// NPC용 - skill.xml에 기술되어 있는 걸로 공격한다.

	// custom - enchant
	MWT_ENCHANT_FIRE_RARE,			
	MWT_ENCHANT_COLD_RARE,
	MWT_ENCHANT_LIGHTNING_RARE,
	MWT_ENCHANT_POISON_RARE,
...
//EXOTICS
	...
	// melee
	MWT_DAGGER_EXOTIC,
	MWT_DUAL_DAGGER_EXOTIC,
	MWT_KATANA_EXOTIC,
	MWT_GREAT_SWORD_EXOTIC,
	MWT_DOUBLE_KATANA_EXOTIC,

	// range
	MWT_PISTOL_EXOTIC,
	MWT_PISTOLx2_EXOTIC,
	MWT_REVOLVER_EXOTIC,
	MWT_REVOLVERx2_EXOTIC,
	MWT_SMG_EXOTIC,
	MWT_SMGx2_EXOTIC,
	MWT_SHOTGUN_EXOTIC,
	MWT_SAWED_SHOTGUN_EXOTIC,
	MWT_RIFLE_EXOTIC,
	MWT_MACHINEGUN_EXOTIC,
	MWT_ROCKET_EXOTIC,
	MWT_SNIFER_EXOTIC,
	MWT_WFGUN_EXOTIC,
	...
	// custom
	MWT_MED_KIT_EXOTIC,
	MWT_REPAIR_KIT_EXOTIC,
	MWT_BULLET_KIT_EXOTIC,
	MWT_FLASH_BANG_EXOTIC,
	MWT_FRAGMENTATION_EXOTIC,
	MWT_SMOKE_GRENADE_EXOTIC,
	MWT_FOOD_EXOTIC,
	MWT_SKILL_EXOTIC,				// NPC용 - skill.xml에 기술되어 있는 걸로 공격한다.

	// custom - enchant
	MWT_ENCHANT_FIRE_EXOTIC,			
	MWT_ENCHANT_COLD_EXOTIC,
	MWT_ENCHANT_LIGHTNING_EXOTIC,
	MWT_ENCHANT_POISON_EXOTIC,

	// custom
	MWT_POTION_EXOTIC,
	MWT_TRAP_EXOTIC,
	MWT_DYNAMITYE_EXOTIC,
