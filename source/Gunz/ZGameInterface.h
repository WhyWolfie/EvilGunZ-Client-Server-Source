...
//	void LoadCustomBitmap();
	...
	void OnNightFallCreate(void);
	void OnQuestInforCreate(void);
	void OnShopInforCreate(void);
	void OnCharCreationDestroy(void);
	void OnNightFallDestroy(void);
	void OnQuestInforDestroy(void);
	void OnShopInforDestroy(void);
