...
//START RARE
		...
		case MWT_DAGGER_RARE:		// attackS 공격 길이만큼... man_dagger_standshot.elu.ani기준..
			nReturnDelay -= 266;
			break;

		case MWT_DUAL_DAGGER_RARE:		// attackS 공격 길이만큼... man_dagger_standshot.elu.ani기준..
			nReturnDelay -= 266;
			break;

		case MWT_KATANA_RARE:		//	attack1 공격 길이만큼....man_knife_standshot_1.elu.ani
			nReturnDelay -= 299;
			break;

		case MWT_DOUBLE_KATANA_RARE:	//	attack1 공격 길이만큼.... man_blade_standshot_1.elu.ani 
			nReturnDelay -= 299;
			break;

		case MWT_GREAT_SWORD_RARE:	// attack1 공격 길이만큼.... man_sword_standshot_1.elu.ani
			nReturnDelay -= 399;
			break;

//START EXOTIC
		
		case MWT_DAGGER_EXOTIC:		// attackS 공격 길이만큼... man_dagger_standshot.elu.ani기준..
			nReturnDelay -= 266;
			break;

		case MWT_DUAL_DAGGER_EXOTIC:	// attack1 공격 길이만큼.... man_2hdagger_standshot_1.elu.ani
			nReturnDelay -= 299;
			break;

		case MWT_KATANA_EXOTIC:		//	attack1 공격 길이만큼....man_knife_standshot_1.elu.ani
			nReturnDelay -= 299;
			break;

		case MWT_DOUBLE_KATANA_EXOTIC:	//	attack1 공격 길이만큼.... man_blade_standshot_1.elu.ani 
			nReturnDelay -= 299;
			break;

		case MWT_GREAT_SWORD_EXOTIC:	// attack1 공격 길이만큼.... man_sword_standshot_1.elu.ani
			nReturnDelay -= 399;
			break;
...
void ZCharacter::InitProperties()
{
	...
	if(strstr(strlwr((char*)ZGetGameClient()->GetStageName()), "[button09]"))
	{
...
void ZCharacter::OnDamaged(ZObject* pAttacker, rvector srcPos, ZDAMAGETYPE damageType, MMatchWeaponType weaponType, float fDamage, float fPiercingRatio, int nMeleeType)
{
	...
	ZObject::OnDamaged(pAttacker,srcPos,damageType,weaponType,fDamage,fPiercingRatio,nMeleeType);
        ...
        if (strstr(ZGetGameClient()->GetStageName(), "[button11]") && pAttacker == ZGetGame()->m_pMyCharacter) {
