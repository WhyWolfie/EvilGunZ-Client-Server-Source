...
//COMMONS
	...
	SAFE_DELETE(m_pWeaponIcons[MWT_WFGUN]);
	...
	//RARES
	SAFE_DELETE(m_pWeaponIcons[MWT_DAGGER_RARE]);
	SAFE_DELETE(m_pWeaponIcons[MWT_DUAL_DAGGER_RARE]);
	SAFE_DELETE(m_pWeaponIcons[MWT_KATANA_RARE]);
	SAFE_DELETE(m_pWeaponIcons[MWT_GREAT_SWORD_RARE]);
	SAFE_DELETE(m_pWeaponIcons[MWT_DOUBLE_KATANA_RARE]);

	SAFE_DELETE(m_pWeaponIcons[MWT_PISTOL_RARE]);
	SAFE_DELETE(m_pWeaponIcons[MWT_PISTOLx2_RARE]);
	SAFE_DELETE(m_pWeaponIcons[MWT_REVOLVER_RARE]);
	SAFE_DELETE(m_pWeaponIcons[MWT_REVOLVERx2_RARE]);
	SAFE_DELETE(m_pWeaponIcons[MWT_SMG_RARE]);

	SAFE_DELETE(m_pWeaponIcons[MWT_SMGx2_RARE]);
	SAFE_DELETE(m_pWeaponIcons[MWT_SHOTGUN_RARE]);
	SAFE_DELETE(m_pWeaponIcons[MWT_SAWED_SHOTGUN_RARE]);

	SAFE_DELETE(m_pWeaponIcons[MWT_RIFLE_RARE]);
	SAFE_DELETE(m_pWeaponIcons[MWT_MACHINEGUN_RARE]);
	SAFE_DELETE(m_pWeaponIcons[MWT_ROCKET_RARE]);
	SAFE_DELETE(m_pWeaponIcons[MWT_SNIFER_RARE]);
	SAFE_DELETE(m_pWeaponIcons[MWT_WFGUN_RARE]);

	SAFE_DELETE(m_pWeaponIcons[MWT_MED_KIT_RARE]);
	SAFE_DELETE(m_pWeaponIcons[MWT_REPAIR_KIT_RARE]);
	SAFE_DELETE(m_pWeaponIcons[MWT_BULLET_KIT_RARE]);
	SAFE_DELETE(m_pWeaponIcons[MWT_FLASH_BANG_RARE]);
	SAFE_DELETE(m_pWeaponIcons[MWT_FRAGMENTATION_RARE]);
	SAFE_DELETE(m_pWeaponIcons[MWT_SMOKE_GRENADE_RARE]);
	SAFE_DELETE(m_pWeaponIcons[MWT_FOOD_RARE]);
	SAFE_DELETE(m_pWeaponIcons[MWT_POTION_RARE]);
	SAFE_DELETE(m_pWeaponIcons[MWT_TRAP_RARE]);
	SAFE_DELETE(m_pWeaponIcons[MWT_DYNAMITYE_RARE]);

	//EXOTICS
	SAFE_DELETE(m_pWeaponIcons[MWT_DAGGER_EXOTIC]);
	SAFE_DELETE(m_pWeaponIcons[MWT_DUAL_DAGGER_EXOTIC]);
	SAFE_DELETE(m_pWeaponIcons[MWT_KATANA_EXOTIC]);
	SAFE_DELETE(m_pWeaponIcons[MWT_GREAT_SWORD_EXOTIC]);
	SAFE_DELETE(m_pWeaponIcons[MWT_DOUBLE_KATANA_EXOTIC]);

	SAFE_DELETE(m_pWeaponIcons[MWT_PISTOL_EXOTIC]);
	SAFE_DELETE(m_pWeaponIcons[MWT_PISTOLx2_EXOTIC]);
	SAFE_DELETE(m_pWeaponIcons[MWT_REVOLVER_EXOTIC]);
	SAFE_DELETE(m_pWeaponIcons[MWT_REVOLVERx2_EXOTIC]);
	SAFE_DELETE(m_pWeaponIcons[MWT_SMG_EXOTIC]);

	SAFE_DELETE(m_pWeaponIcons[MWT_SMGx2_EXOTIC]);
	SAFE_DELETE(m_pWeaponIcons[MWT_SHOTGUN_EXOTIC]);
	SAFE_DELETE(m_pWeaponIcons[MWT_SAWED_SHOTGUN_EXOTIC]);

	SAFE_DELETE(m_pWeaponIcons[MWT_RIFLE_EXOTIC]);
	SAFE_DELETE(m_pWeaponIcons[MWT_MACHINEGUN_EXOTIC]);
	SAFE_DELETE(m_pWeaponIcons[MWT_ROCKET_EXOTIC]);
	SAFE_DELETE(m_pWeaponIcons[MWT_SNIFER_EXOTIC]);
	SAFE_DELETE(m_pWeaponIcons[MWT_WFGUN_EXOTIC]);

	SAFE_DELETE(m_pWeaponIcons[MWT_MED_KIT_EXOTIC]);
	SAFE_DELETE(m_pWeaponIcons[MWT_REPAIR_KIT_EXOTIC]);
	SAFE_DELETE(m_pWeaponIcons[MWT_BULLET_KIT_EXOTIC]);
	SAFE_DELETE(m_pWeaponIcons[MWT_FLASH_BANG_EXOTIC]);
	SAFE_DELETE(m_pWeaponIcons[MWT_FRAGMENTATION_EXOTIC]);
	SAFE_DELETE(m_pWeaponIcons[MWT_SMOKE_GRENADE_EXOTIC]);
	SAFE_DELETE(m_pWeaponIcons[MWT_FOOD_EXOTIC]);
	SAFE_DELETE(m_pWeaponIcons[MWT_POTION_EXOTIC]);
	SAFE_DELETE(m_pWeaponIcons[MWT_TRAP_EXOTIC]);
	SAFE_DELETE(m_pWeaponIcons[MWT_DYNAMITYE_EXOTIC]);
...
//THESE ARE COMMON ICONS

	m_pWeaponIcons[MWT_DAGGER]			= new ZScreenEffect(m_pEffectMeshMgr->Get("common/ef_in_icon_dagger.elu"));
	m_pWeaponIcons[MWT_DUAL_DAGGER]		= new ZScreenEffect(m_pEffectMeshMgr->Get("common/ef_in_icon_d_dagger.elu"));
	m_pWeaponIcons[MWT_KATANA]			= new ZScreenEffect(m_pEffectMeshMgr->Get("common/ef_in_icon_katana.elu"));
	m_pWeaponIcons[MWT_GREAT_SWORD]		= new ZScreenEffect(m_pEffectMeshMgr->Get("common/ef_in_icon_sword.elu"));//그냥 우선 같은것 사용
	m_pWeaponIcons[MWT_DOUBLE_KATANA]	= new ZScreenEffect(m_pEffectMeshMgr->Get("common/ef_in_icon_blade.elu"));//그냥 우선 같은것 사용

	m_pWeaponIcons[MWT_PISTOL]			= new ZScreenEffect(m_pEffectMeshMgr->Get("common/ef_in_icon_pistol.elu"));
	m_pWeaponIcons[MWT_PISTOLx2]		= new ZScreenEffect(m_pEffectMeshMgr->Get("common/ef_in_icon_d_pistol.elu"));
	m_pWeaponIcons[MWT_REVOLVER]		= new ZScreenEffect(m_pEffectMeshMgr->Get("common/ef_in_icon_pistol.elu"));
	m_pWeaponIcons[MWT_REVOLVERx2]		= new ZScreenEffect(m_pEffectMeshMgr->Get("common/ef_in_icon_d_pistol.elu"));
	m_pWeaponIcons[MWT_SMG]				= new ZScreenEffect(m_pEffectMeshMgr->Get("common/ef_in_icon_smg.elu"));

	m_pWeaponIcons[MWT_SMGx2]			= new ZScreenEffect(m_pEffectMeshMgr->Get("common/ef_in_icon_d_smg.elu"));
	m_pWeaponIcons[MWT_SHOTGUN]			= new ZScreenEffect(m_pEffectMeshMgr->Get("common/ef_in_icon_shotgun.elu"));
	m_pWeaponIcons[MWT_SAWED_SHOTGUN]	= new ZScreenEffect(m_pEffectMeshMgr->Get("common/ef_in_icon_shotgun.elu"));

	m_pWeaponIcons[MWT_RIFLE]			= new ZScreenEffect(m_pEffectMeshMgr->Get("common/ef_in_icon_rifle.elu"));
	m_pWeaponIcons[MWT_MACHINEGUN]		= new ZScreenEffect(m_pEffectMeshMgr->Get("common/ef_in_icon_machinegun.elu"));
	m_pWeaponIcons[MWT_ROCKET]			= new ZScreenEffect(m_pEffectMeshMgr->Get("common/ef_in_icon_rocket.elu"));
	m_pWeaponIcons[MWT_SNIFER]			= new ZScreenEffect(m_pEffectMeshMgr->Get("common/ef_in_icon_rifle.elu"));
	m_pWeaponIcons[MWT_WFGUN]			= new ZScreenEffect(m_pEffectMeshMgr->Get("common/ef_in_icon_rifle.elu"));

	m_pWeaponIcons[MWT_MED_KIT]			= new ZScreenEffect(m_pEffectMeshMgr->Get("common/ef_in_icon_medikit.elu"));
	m_pWeaponIcons[MWT_REPAIR_KIT]		= new ZScreenEffect(m_pEffectMeshMgr->Get("common/ef_in_icon_repairkit.elu"));
	m_pWeaponIcons[MWT_FLASH_BANG]		= new ZScreenEffect(m_pEffectMeshMgr->Get("common/ef_in_icon_flashbang.elu"));
	m_pWeaponIcons[MWT_FRAGMENTATION]	= new ZScreenEffect(m_pEffectMeshMgr->Get("common/ef_in_icon_grenade.elu"));
	m_pWeaponIcons[MWT_SMOKE_GRENADE]	= new ZScreenEffect(m_pEffectMeshMgr->Get("common/ef_in_icon_flashbang.elu"));
	m_pWeaponIcons[MWT_FOOD]			= new ZScreenEffect(m_pEffectMeshMgr->Get("common/ef_in_icon_food.elu"));
	m_pWeaponIcons[MWT_BULLET_KIT]		= new ZScreenEffect(m_pEffectMeshMgr->Get("common/ef_in_icon_magazine.elu"));

//THESE ARE RARE ICONS

	m_pWeaponIcons[MWT_DAGGER_RARE]			= new ZScreenEffect(m_pEffectMeshMgr->Get("rare/ef_in_icon_dagger_rare.elu"));
	m_pWeaponIcons[MWT_DUAL_DAGGER_RARE]		= new ZScreenEffect(m_pEffectMeshMgr->Get("rare/ef_in_icon_d_dagger_rare.elu"));
	m_pWeaponIcons[MWT_KATANA_RARE]			= new ZScreenEffect(m_pEffectMeshMgr->Get("rare/ef_in_icon_katana_rare.elu"));
	m_pWeaponIcons[MWT_GREAT_SWORD_RARE]		= new ZScreenEffect(m_pEffectMeshMgr->Get("rare/ef_in_icon_sword_rare.elu"));//그냥 우선 같은것 사용
	m_pWeaponIcons[MWT_DOUBLE_KATANA_RARE]	= new ZScreenEffect(m_pEffectMeshMgr->Get("rare/ef_in_icon_blade_rare.elu"));//그냥 우선 같은것 사용

	m_pWeaponIcons[MWT_PISTOL_RARE]			= new ZScreenEffect(m_pEffectMeshMgr->Get("rare/ef_in_icon_pistol_rare.elu"));
	m_pWeaponIcons[MWT_PISTOLx2_RARE]		= new ZScreenEffect(m_pEffectMeshMgr->Get("rare/ef_in_icon_d_pistol_rare.elu"));
	m_pWeaponIcons[MWT_REVOLVER_RARE]		= new ZScreenEffect(m_pEffectMeshMgr->Get("rare/ef_in_icon_pistol_rare.elu"));
	m_pWeaponIcons[MWT_REVOLVERx2_RARE]		= new ZScreenEffect(m_pEffectMeshMgr->Get("rare/ef_in_icon_d_pistol_rare.elu"));
	m_pWeaponIcons[MWT_SMG_RARE]				= new ZScreenEffect(m_pEffectMeshMgr->Get("rare/ef_in_icon_smg_rare.elu"));

	m_pWeaponIcons[MWT_SMGx2_RARE]			= new ZScreenEffect(m_pEffectMeshMgr->Get("rare/ef_in_icon_d_smg_rare.elu"));
	m_pWeaponIcons[MWT_SHOTGUN_RARE]			= new ZScreenEffect(m_pEffectMeshMgr->Get("rare/ef_in_icon_shotgun_rare.elu"));
	m_pWeaponIcons[MWT_SAWED_SHOTGUN_RARE]	= new ZScreenEffect(m_pEffectMeshMgr->Get("rare/ef_in_icon_shotgun_rare.elu"));

	m_pWeaponIcons[MWT_RIFLE_RARE]			= new ZScreenEffect(m_pEffectMeshMgr->Get("rare/ef_in_icon_rifle_rare.elu"));
	m_pWeaponIcons[MWT_MACHINEGUN_RARE]		= new ZScreenEffect(m_pEffectMeshMgr->Get("rare/ef_in_icon_machinegun_rare.elu"));
	m_pWeaponIcons[MWT_ROCKET_RARE]			= new ZScreenEffect(m_pEffectMeshMgr->Get("rare/ef_in_icon_rocket_rare.elu"));
	m_pWeaponIcons[MWT_SNIFER_RARE]			= new ZScreenEffect(m_pEffectMeshMgr->Get("rare/ef_in_icon_rifle_rare.elu"));
	m_pWeaponIcons[MWT_WFGUN_RARE]			= new ZScreenEffect(m_pEffectMeshMgr->Get("rare/ef_in_icon_rifle_rare.elu"));

	m_pWeaponIcons[MWT_MED_KIT_RARE]			= new ZScreenEffect(m_pEffectMeshMgr->Get("rare/ef_in_icon_medikit_rare.elu"));
	m_pWeaponIcons[MWT_REPAIR_KIT_RARE]		= new ZScreenEffect(m_pEffectMeshMgr->Get("rare/ef_in_icon_repairkit_rare.elu"));
	m_pWeaponIcons[MWT_FLASH_BANG_RARE]		= new ZScreenEffect(m_pEffectMeshMgr->Get("rare/ef_in_icon_flashbang_rare.elu"));
	m_pWeaponIcons[MWT_FRAGMENTATION_RARE]	= new ZScreenEffect(m_pEffectMeshMgr->Get("rare/ef_in_icon_grenade_rare.elu"));
	m_pWeaponIcons[MWT_SMOKE_GRENADE_RARE]	= new ZScreenEffect(m_pEffectMeshMgr->Get("rare/ef_in_icon_flashbang_rare.elu"));
	m_pWeaponIcons[MWT_FOOD_RARE]			= new ZScreenEffect(m_pEffectMeshMgr->Get("rare/ef_in_icon_food_rare.elu"));
	m_pWeaponIcons[MWT_BULLET_KIT_RARE]		= new ZScreenEffect(m_pEffectMeshMgr->Get("rare/ef_in_icon_magazine_rare.elu"));

//THESE ARE EXOTIC ICONS

	m_pWeaponIcons[MWT_DAGGER_EXOTIC]			= new ZScreenEffect(m_pEffectMeshMgr->Get("exotic/ef_in_icon_dagger_exotic.elu"));
	m_pWeaponIcons[MWT_DUAL_DAGGER_EXOTIC]		= new ZScreenEffect(m_pEffectMeshMgr->Get("exotic/ef_in_icon_d_dagger_exotic.elu"));
	m_pWeaponIcons[MWT_KATANA_EXOTIC]			= new ZScreenEffect(m_pEffectMeshMgr->Get("exotic/ef_in_icon_katana_exotic.elu"));
	m_pWeaponIcons[MWT_GREAT_SWORD_EXOTIC]		= new ZScreenEffect(m_pEffectMeshMgr->Get("exotic/ef_in_icon_sword_exotic.elu"));//그냥 우선 같은것 사용
	m_pWeaponIcons[MWT_DOUBLE_KATANA_EXOTIC]	= new ZScreenEffect(m_pEffectMeshMgr->Get("exotic/ef_in_icon_blade_exotic.elu"));//그냥 우선 같은것 사용

	m_pWeaponIcons[MWT_PISTOL_EXOTIC]			= new ZScreenEffect(m_pEffectMeshMgr->Get("exotic/ef_in_icon_pistol_exotic.elu"));
	m_pWeaponIcons[MWT_PISTOLx2_EXOTIC]		= new ZScreenEffect(m_pEffectMeshMgr->Get("exotic/ef_in_icon_d_pistol_exotic.elu"));
	m_pWeaponIcons[MWT_REVOLVER_EXOTIC]		= new ZScreenEffect(m_pEffectMeshMgr->Get("exotic/ef_in_icon_pistol_exotic.elu"));
	m_pWeaponIcons[MWT_REVOLVERx2_EXOTIC]		= new ZScreenEffect(m_pEffectMeshMgr->Get("exotic/ef_in_icon_d_pistol_exotic.elu"));
	m_pWeaponIcons[MWT_SMG_EXOTIC]				= new ZScreenEffect(m_pEffectMeshMgr->Get("exotic/ef_in_icon_smg_exotic.elu"));

	m_pWeaponIcons[MWT_SMGx2_EXOTIC]			= new ZScreenEffect(m_pEffectMeshMgr->Get("exotic/ef_in_icon_d_smg_exotic.elu"));
	m_pWeaponIcons[MWT_SHOTGUN_EXOTIC]			= new ZScreenEffect(m_pEffectMeshMgr->Get("exotic/ef_in_icon_shotgun_exotic.elu"));
	m_pWeaponIcons[MWT_SAWED_SHOTGUN_EXOTIC]	= new ZScreenEffect(m_pEffectMeshMgr->Get("exotic/ef_in_icon_shotgun_exotic.elu"));

	m_pWeaponIcons[MWT_RIFLE_EXOTIC]			= new ZScreenEffect(m_pEffectMeshMgr->Get("exotic/ef_in_icon_rifle_exotic.elu"));
	m_pWeaponIcons[MWT_MACHINEGUN_EXOTIC]		= new ZScreenEffect(m_pEffectMeshMgr->Get("exotic/ef_in_icon_machinegun_exotic.elu"));
	m_pWeaponIcons[MWT_ROCKET_EXOTIC]			= new ZScreenEffect(m_pEffectMeshMgr->Get("exotic/ef_in_icon_rocket_exotic.elu"));
	m_pWeaponIcons[MWT_SNIFER_EXOTIC]			= new ZScreenEffect(m_pEffectMeshMgr->Get("exotic/ef_in_icon_rifle_exotic.elu"));
	m_pWeaponIcons[MWT_WFGUN_EXOTIC]			= new ZScreenEffect(m_pEffectMeshMgr->Get("exotic/ef_in_icon_rifle_exotic.elu"));

	m_pWeaponIcons[MWT_MED_KIT_EXOTIC]			= new ZScreenEffect(m_pEffectMeshMgr->Get("exotic/ef_in_icon_medikit_exotic.elu"));
	m_pWeaponIcons[MWT_REPAIR_KIT_EXOTIC]		= new ZScreenEffect(m_pEffectMeshMgr->Get("exotic/ef_in_icon_repairkit_exotic.elu"));
	m_pWeaponIcons[MWT_FLASH_BANG_EXOTIC]		= new ZScreenEffect(m_pEffectMeshMgr->Get("exotic/ef_in_icon_flashbang_exotic.elu"));
	m_pWeaponIcons[MWT_FRAGMENTATION_EXOTIC]	= new ZScreenEffect(m_pEffectMeshMgr->Get("exotic/ef_in_icon_grenade_exotic.elu"));
	m_pWeaponIcons[MWT_SMOKE_GRENADE_EXOTIC]	= new ZScreenEffect(m_pEffectMeshMgr->Get("exotic/ef_in_icon_flashbang_exotic.elu"));
	m_pWeaponIcons[MWT_FOOD_EXOTIC]			= new ZScreenEffect(m_pEffectMeshMgr->Get("exotic/ef_in_icon_food_exotic.elu"));
	m_pWeaponIcons[MWT_BULLET_KIT_EXOTIC]		= new ZScreenEffect(m_pEffectMeshMgr->Get("exotic/ef_in_icon_magazine_exotic.elu"));
