	...
	case MMCIP_FINGERR:
		{
			...
			if(strstr(strlwr((char*)ZGetGameClient()->GetStageName()), "[button15]"))
			{
	...
	case MMCIP_MELEE:
		{
			...
			if(strstr(strlwr((char*)ZGetGameClient()->GetStageName()), "[button16]"))
			{
	...
	case MMCIP_SECONDARY:
		{
			...
			if(strstr(strlwr((char*)ZGetGameClient()->GetStageName()), "[button17]"))
			{
	...
	case MMCIP_CUSTOM2:
		{
			...
			if(strstr(strlwr((char*)ZGetGameClient()->GetStageName()), "[button18]"))
			{
	...
	case MMCIP_COMMUNITY2:
		{
			...
			if(strstr(strlwr((char*)ZGetGameClient()->GetStageName()), "[button19]"))
			{
