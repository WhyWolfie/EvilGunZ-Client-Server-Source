...
BEGIN_IMPLEMENT_LISTENER(ZGetShowNightFallButtonListener, MBTN_CLK_MSG)
	ZGetGameInterface()->SetState(GUNZ_NIGHTFALL);
END_IMPLEMENT_LISTENER()

BEGIN_IMPLEMENT_LISTENER(ZGetShowQuestInforButtonListener, MBTN_CLK_MSG)
	ZGetGameInterface()->SetState(GUNZ_QUESTINFOR);
END_IMPLEMENT_LISTENER()

BEGIN_IMPLEMENT_LISTENER(ZGetShowShopInforButtonListener, MBTN_CLK_MSG)
	ZGetGameInterface()->SetState(GUNZ_SHOPINFOR);
END_IMPLEMENT_LISTENER()
