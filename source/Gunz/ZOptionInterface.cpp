...
static int widths[]={ 640,800,1024,1280,1366,1600,1280,1440,1650,1920,2560};
static int heights[]={ 480,600,768,960,768,1200,800,900,1050,1080,1600};
...
if( REnumAdapterMode( D3DADAPTER_DEFAULT,format[i], idm,  &ddm ))
	...
	{	
		...
		//Trail Option
		MButton* pWidget = (MButton*)pResource->FindWidget("TrailOption");
		if ( pWidget )
		{
